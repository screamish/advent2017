...
spec_day2 :: Spec
spec_day2 = parallel $ do
  let input = [here|3751	3769	2769	2039	2794	240	3579	1228	4291	220	324	3960	211	1346	237	1586
  ...
  it "given a spreadsheet, calculates the checksum" $ do
    let input = "5 1 9 5\n 7 5 3\n 2 4 6 8"
    Day2.checksum input `shouldBe` 18
  it "solves part 1" $ do
    Day2.checksum input `shouldBe` 36174
  describe "part 2" $ do
    it "given a spreadsheet, calculates the checksum" $ do
      let input = [here|5 9 2 8
                        9 4 7 3
                        3 8 6 5|]
